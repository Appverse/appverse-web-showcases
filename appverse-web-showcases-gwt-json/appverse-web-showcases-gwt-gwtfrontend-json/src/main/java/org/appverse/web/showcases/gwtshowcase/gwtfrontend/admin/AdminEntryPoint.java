...
public class AdminEntryPoint extends AppverseRestAbstractEntryPoint {
    ...
    //App path is just the same path the app have configured in the Jersey servlet url-pattern parameter + jsonservices (jsoncontroller).
    private String path="admin/rest/jsonservices";
