...
-- 1 Extra role to test insertion
INSERT INTO ROLE (ID, CREATED, CREATED_BY, NAME, STATUS, ACTIVE, UPDATED, UPDATED_BY, VERSION) VALUES (5, current_date, '', 'ROLE_FOR_TEST5', 'a', 1, current_date, '', 1);
UPDATE SEQUENCE SET SEQ_COUNT = 6 WHERE SEQ_NAME = 'ROLE_SEQ';
